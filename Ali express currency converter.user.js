...
// @description  converts euro to DZD in aliexpress.com, Make sure the currency is set to EUR and aliexpress language is set to ENGLISH, You can use hotkeys (alt+shift), (ctrl+alt)
// @version      1.0
